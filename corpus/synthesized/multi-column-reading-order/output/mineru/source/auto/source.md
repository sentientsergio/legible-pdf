...
Marker 05. A common failure mode is the converter treating each column as a separate stream and reading column one of page one followed by column one of page two.
...
Marker 10. A reading-order resolver then sorts those bounding boxes into a sequence that approximates the order a human reader would follow.
...
Marker 15. A correct readingorder resolver places marker fifteen after marker fourteen, regardless of which page each occupies.
